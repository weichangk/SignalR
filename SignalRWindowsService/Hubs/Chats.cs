...
namespace SignalRWindowsService
{
    ...
    public class Chats : Hub
    {
        ...
        private void AddOnline()
        {
            ...
            SignalRServiceChat.log.Info($"ClientId:{clientId} UserId:{userId} AddOnline");
        }
        /// <summary>
        /// 移除在线用户
        /// </summary>
        private void RemoveOnline()
        {
            ...
            SignalRServiceChat.log.Info($"ClientId:{clientId} UserId:{userId} RemoveOnline");
        }
        /// <summary>
        /// 获取登录用户Id
        /// </summary>
        ...
        public void SendMsgByUserId(string sendUserId, string revUserId, string msg, DateTime time, bool isSysMsg)
        {
            ...
            SignalRServiceChat.log.Info($"{time} isSysMsg:{isSysMsg} Id:{sendUserId} Send To Id:{revUserId} Msg:{msg}");
        }
        /// <summary>
        /// 向所有客户端发送消息
        /// </summary>
        ...
        public void SendMsgAll(string sendUserId, string msg, DateTime time, bool isSysMsg)
        {
            ...
            SignalRServiceChat.log.Info($"{time} isSysMsg:{isSysMsg} Id:{sendUserId} Send Msg:{msg}");
        }
        #endregion
    }
}
