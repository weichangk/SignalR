...
namespace SignalRClientTest
{
    ...
    {
        readonly HubClient hubClient = new HubClient(@"https://localhost:44342/", "ChatsHub", "Form2");
        public Form2()
        {
            InitializeComponent();
        }
        ...
        {
            hubClient.CallMethod("sendMsgByUserId", hubClient.UserId, "Form3", this.textBox1.Text, DateTime.Now, false);//发送信息
        }
